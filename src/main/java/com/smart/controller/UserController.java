...
public class UserController {
			...
			HttpSession session)
	{
		...
		{
			//upload to file the folder and update the name to contact
	...
	public String showContacts(@PathVariable("page") Integer page,Model m,Principal principal)
	{
		...
		//contact ki list ko show krna hai
	...
	public String updateForm(@PathVariable("cId") Integer cId,Model m)
	{
		...
		m.addAttribute("title","Udate Contact");
								...
								Principal principal,HttpSession session)
	{
		...
		{
			//error
			session.setAttribute("message",new Message("Wrong Old password plzz retype...","danger"));
